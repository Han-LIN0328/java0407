public class Pic3HeightMeasurement {
    ...
    public static void main(String[] args) {
        ...
        double[] depthLine1_p1 = {120, 920, 1.0}; // 左側延伸線-近端 (請替換)
        double[] depthLine1_p2 = {280, 580, 1.0}; // 左側延伸線-遠端 (請替換)
        double[] depthLine2_p1 = {1100, 920, 1.0}; // 右側延伸線-近端 (請替換)
        double[] depthLine2_p2 = {920, 580, 1.0}; // 右側延伸線-遠端 (請替換)

        // 2. 找地板上「橫向」的兩條平行線 (求消失點 2)
        double[] horizLine1_p1 = {120, 800, 1.0}; // 近處橫縫-左端 (請替換)
        double[] horizLine1_p2 = {1100, 800, 1.0}; // 近處橫縫-右端 (請替換)
        double[] horizLine2_p1 = {200, 520, 1.0}; // 遠處橫縫-左端 (請替換)
        double[] horizLine2_p2 = {1000, 520, 1.0}; // 遠處橫縫-右端 (請替換)

        // 3. 基準學生 (身穿 JUST DO IT) 的頭頂與腳底座標
        double[] refTop = {620, 360, 1.0}; // JUST DO IT 頭頂 (請替換)
        double[] refBot = {620, 870, 1.0}; // JUST DO IT 腳底 (請替換)
        double refHeightReal = 180.0;      // 基準真實身高為 180 公分

        // 4. 目標學生 (左側，身穿黑衣) 的頭頂與腳底座標
        double[] targetTop = {360, 380, 1.0}; // 黑衣同學 頭頂 (請替換)
        double[] targetBot = {360, 870, 1.0}; // 黑衣同學 腳底 (請替換)
